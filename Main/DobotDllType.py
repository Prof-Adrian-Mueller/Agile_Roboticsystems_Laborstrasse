...
def load():
    if platform.system() == "Windows":
        ...
        print(
            "Die von Ihnen verwendete DLL ist 64-Bit. Um einen reibungslosen Betrieb zu gewährleisten, stellen Sie bitte sicher, dass Ihre Python-Umgebung ebenfalls 64-Bit ist.")
        print("Python-Umgebung ist:", platform.architecture())
        return CDLL("Main/DobotDll.dll", RTLD_GLOBAL)
    elif platform.system() == "Darwin":
        return CDLL("Main/libDobotDll.dylib", RTLD_GLOBAL)
